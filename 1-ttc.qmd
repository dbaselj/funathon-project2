...
Of course, you can play with hyperparameters if you want: add more epochs, change the learning rate and the batch size... Remember that you are training the model using CPUs, so avoid big models that will take a lot of time to train.
:::
